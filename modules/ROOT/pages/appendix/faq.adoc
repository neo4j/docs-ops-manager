...
** It is possible to deploy NOM into a supported cloud environment, using tarball and zip installations. It is also possible to deploy NOM server as a docker container if the cloud environment uses containers.
