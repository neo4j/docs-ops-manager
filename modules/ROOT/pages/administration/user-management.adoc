...
(including other *Administrators*) and configure permissions.
====
...
==== Assigning Permissions On Features
...
|===
|Feature (scope) |Access levels |Description
...
permission the most restrictive is applied. *Example*: for a user, a glob pattern `\*` defines access level "Edit" for the "Security"
