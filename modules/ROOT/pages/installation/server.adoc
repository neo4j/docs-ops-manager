...
[NOTE]
====
If the certificate is not issued by a public CA, the intermediate certificate or the certifcate from CA needs to be added to Java's trust store using the following command -
