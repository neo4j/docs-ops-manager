...
| For Entra ID and Okta IdP. Authority URL of the Entra ID tenant. It can be found in the "Endpoints" section of the application page.
...
| For Entra ID and Okta IdP. Issuer URL for validating the access token. Currently, it is the same as the authority URL with `/v2.0` appended to it.
