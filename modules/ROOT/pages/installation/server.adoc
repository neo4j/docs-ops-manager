...
Releases of Neo4j enterprise now all come bundled with the most current version of NOM at the time of that Neo4j release. Please note that this does not have to be the most current version of NOM.
...
In any case, please extract the content from the downloaded `.zip` or `.tar.gz` file to wherever directory you want to operate NOM from
