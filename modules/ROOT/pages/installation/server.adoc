...
| ISO-8601 duration. Aggregated metric nodes older than this are deleted. Default: `P31D`. (optional). `P31D` is the maximum retention time supported by the UI.
| `P14D`
