...
The following are the minimum requirements for a compatible Entra ID App registration:
...
In addition to the xref:./configuration.adoc#_common_options[common options], the following supplemental configuration options are required for setting up SSO with Entra ID.
