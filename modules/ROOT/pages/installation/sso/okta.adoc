...
* It is recommended to create/assign two user `Groups` to be mapped to NOM's Admin and Read-only administrator roles to keep the NOM server configuration simple.
