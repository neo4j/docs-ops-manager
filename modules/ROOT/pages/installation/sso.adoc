...
The configuration contains options needed to obtain an access token on the NOM frontend side, validate the access token on the NOM backend side and map token claims to an SSO user in NOM, including assign a NOM role to the SSO user.
