...
To simplify configuring NOM server in the chart, following values can be set in `values.yaml` under `ssoConfigs` to be translated to NOM srver SSO configuration:
