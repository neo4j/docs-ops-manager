...
=======
Refer to the link:https://neo4j.com/docs/operations-manual/current/installation/)[Operations Manual -> Installation] for information on how to install Neo4j.
>>>>>>> 71c47d9 (Document using Cypher 5 for NOM persistence (#262) (#265))
...
For more details see link:https://neo4j.com/docs/cypher-manual/current/queries/select-version/[Cypher Manual -> Select Cypher version].
