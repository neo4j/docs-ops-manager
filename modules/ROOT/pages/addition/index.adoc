...
. Check that there is a value for 'Last contact time'
...
. Click on the configuration icon and check all the configuration is as expected
. Navigate to the home page and wait for DBMS to appear, this can take a few minutes
. Select Alerts tab and check there are no alerts for the new DBMS
...
+
image::home-dbms-context-menu.png[width=800]
+
. Type new name
+