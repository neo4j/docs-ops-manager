...
Before adding a DBMS instance for NOM monitoring, an agent needs to be registered with NOM server which provides server communication configuration for the agent.
