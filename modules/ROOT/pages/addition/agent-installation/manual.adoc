...
Run the following commands to permanently change the SELinux context of the agent binary:
+
...
----
+
<EXTRACTED_DIRECTORY_PATH> should be replaced with the path to the extracted diretory
