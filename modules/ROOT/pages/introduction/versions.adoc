...
NOM persistence should be deployed using Neo4j Enterprise Edition 5 LTS or later, although we would recommend using the latest version and keeping this upgraded where possible.
