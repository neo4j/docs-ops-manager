...
|read-only Administrator (for SSO-user only)
| Has view-only access to the following features of NOM: DBMS status, metrics and logs, as well as agents and the upgrades page.
|===
