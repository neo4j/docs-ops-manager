...
[NOTE]
====
Before starting the upgrade process, it is recommended to backup your existing NOM installation folder.
====

[[server-linux]]
=== On Linux

. Backup any files you've modified inside the current NOM server directory.
